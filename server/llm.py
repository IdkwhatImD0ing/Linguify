...
class LlmClient:
    def __init__(self, language: str, image_base64: str):
        ...
        self.begin_sentence = f"Hi there! Let's chat about the picture you uploaded in {language}. Are you ready?"
...
Note: Always conduct the conversation in the user's target language, which is {language}. If the user struggles, provide assistance in a way that enhances their learning experience."""
